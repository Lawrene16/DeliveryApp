...
var AddsubjecttypePage = /** @class */ (function () {
    function AddsubjecttypePage(camera, DomSanitizer, router, httpClient, loadingCtrl, actionSheetController, toastCtrl, file) {
        this.camera = camera;
    ...
    //   });
    // }
    AddsubjecttypePage.prototype.AccessCamera = function () {
        var _this = this;
    ...
    AddsubjecttypePage.prototype.AccessGallery = function () {
        var _this = this;
    ...
    AddsubjecttypePage.prototype.save = function () {
    ...
    AddsubjecttypePage.prototype.insertImage = function (base64img) {
        var _this = this;
        this.loadingCtrl.create({ message: "Please wait" }).then(function (res) {
            res.present();
            ...
            _this.httpClient.post("https://tawsil.mr/api/v1/subject_types", reqbody, { headers: headers }).subscribe(function (data) {
                console.log(data);
                res.dismiss();
                _this.presentToast("Subject type added successfully");
